...
def get_min_amount_to_swap(amount_to_swap: int, slippage: int) -> int:
    ...
    Args:
        ...
        slippage:       slippage, %
    """
    return amount_to_swap - (amount_to_swap * slippage) // 1000


async def get_correct_amount_and_min_amount(
        token_contract: AsyncContract, amount_to_swap: int, slippage: int = 5) -> (int, int):
