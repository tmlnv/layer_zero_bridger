...
usdc_avalanche_address = fantom_w3.to_checksum_address('0xb97ef9ef8734c71904d8002f8b6bc66dd9c48a6e')
...
stargate_avalanche_contract = fantom_w3.eth.contract(address=stargate_avalanche_address, abi=stargate_abi)
...
usdc_avalanche_contract = fantom_w3.eth.contract(address=usdc_avalanche_address, abi=usdc_abi)
